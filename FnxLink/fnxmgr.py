...
parser.add_argument("--binary", metavar="BINARY FILE", dest="binary_file",
                    help="Upload a binary file to the F256's RAM.")

parser.add_argument("--upload", metavar="BINARY FILE", dest="binary_file",
                    help="Upload a binary file to the F256's RAM.")
...
parser.add_argument("--upload-hex", metavar="HEX FILE", dest="hex_file",
